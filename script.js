            ...
            room.querySelectorAll(SELECTORS.set).forEach((set) => {
                ...
                if (w > 0 && h > 0) {
                    if (variant === "ทึบ" || variant === "ทึบ&โปร่ง") {
                        ...
                        opaquePrice = Math.ceil(opaqueYards) * (baseRaw + sPlus + hPlus);
                        opaqueTrack = w;
                    }
                    if (variant === "โปร่ง" || variant === "ทึบ&โปร่ง") {
                        const sheerBase = clamp01(set.querySelector('select[name="sheer_price_per_m"]')?.value);
                        sheerYards = CALC.fabricYardage(style, w);
                        sheerPrice = Math.ceil(sheerYards) * (sheerBase + hPlus);
                        sheerTrack = w;
                    }
                }
            ...
            room.sets.forEach((set, setIndex) => {
                ...
                if (w > 0 && h > 0) {
                    if (variant === "ทึบ" || variant === "ทึบ&โปร่ง") {
                        ...
                        const opaquePrice = Math.ceil(setOpaqueYards) * (baseRaw + sPlus + hPlus);
                        setOpaqueTrack = w;
                    ...
                    if (variant === "โปร่ง" || variant === "ทึบ&โปร่ง") {
                        ...
                        const sheerPrice = Math.ceil(setSheerYards) * (sheerBase + hPlus);
                        setSheerTrack = w;
                        setPrice += sheerPrice;
                    }
                }
