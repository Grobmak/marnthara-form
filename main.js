...
import { SELECTORS, STORAGE_KEY, WEBHOOK_URL, SHOP_CONFIG, PRICING } from './config.js';
import { saveData, buildPayload } from './storage.js';
import { generateSummaryText, generateQuotationHtml, generateOverviewHtml } from './documentGenerator.js';
import {
    addRoom,
    recalcAll,
    loadPayload,
